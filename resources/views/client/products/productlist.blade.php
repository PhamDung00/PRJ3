      ...
      <div class="shop-list flex-grow-1">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center" style="background-color: #87CEEB;">
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2 class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">Shoes <br><strong>To Be Strong</strong></h2>
                ...
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #87CEEB;">
                    <img loading="lazy" src="https://coolmaterial.com/wp-content/uploads/2018/12/adidasxWhite-Mountaineering-Terrex-Outdoor-Shoes-2.jpg" width="630" height="450" alt="Women's accessories" class="slideshow-bg__img object-fit-cover">
                  </div>
                </div>
              </div><!-- /.slideshow-item -->
            </div><!-- /.slideshow-item -->
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
            <a href="http://127.0.0.1:8000" class="menu-link menu-link_us-s text-uppercase fw-medium" >Home</a>
              ...
              <div class="product-card-wrapper">
                  <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                              ...
                              <div class="swiper-wrapper">
                                  <div class="swiper-slide">
                                      <a href="{{ route('client.products.productdetail', $product->id) }}">
                                        ...
                                        <img loading="lazy" src="/{{ $product->images[0]["url"] }}" width="300" height="400" 
                                        alt="{{ $product->name??"" }}" 
                                        class="pc__img">
                                        @else
                                            <img src="https://vipha.co/wp-content/themes/vipha/images/empty-img.png" alt="">
                                        @endif
                                      </a>
                                  </div>
                                  <div class="swiper-slide">
                                      <a href="{{ route('client.products.productdetail', $product->id) }}">
                                        @if (isset($product->images[0]))                                            
                                        <img loading="lazy" src="/{{ $product->images[0]["url"] }}" width="330" height="400" 
                                        alt="{{ $product->name??"" }}" 
                                        class="pc__img">
                                        @else
                                            <img src="https://vipha.co/wp-content/themes/vipha/images/empty-img.png" alt="">
                      ...
                      <div class="pc__info position-relative">
                          <p class="pc__category">Shoes</p>
                          <h6 class="pc__title"><a href="{{ route('client.products.productdetail', $product->id) }}">{{ $product->name }}</a></h6>
