@auth
    @if (auth()->user()->role_id == 5)
        ...
        <head>
            ...
            <link id="USE_CHAT_GPT_AI_CONTENT_CSS_LINK_TAG" rel="stylesheet"
        ...
        <body
            ...
            <div style="height:auto; min-height:100%; ">
                <div style="text-align: center; width:800px; margin-left: -400px; position:absolute; top: 30%; left:50%;">
                    ...
                    <p>You doesn't have permission to access this page</p>
                </div>
            </div>
            <div
            ...
            <use-chat-gpt-ai id="USE_CHAT_GPT_AI_ROOT" class="close"
                data-version="4.3.5"></use-chat-gpt-ai><use-chat-gpt-ai-content-menu
                id="USE_CHAT_GPT_AI_ROOT_Context_Menu"></use-chat-gpt-ai-content-menu><use-chat-gpt-ai
                id="MAXAI_GLOBAL_VIDEO_POPUP_CONTAINER_ID" data-status="hide"></use-chat-gpt-ai><max-ai-minimum-app
                id="USE_CHAT_GPT_AI_ROOT_Minimize_Container" data-version="4.3.5"></max-ai-minimum-app>
            <div id="MAXAI_SNACKBAR_CONTAINER" style="z-index: 2147483647; color: rgb(255, 255, 255); position: absolute;">
            </div>
        </body>
    ...
    @else
        ...
        <!-- Mirrored from maraviyainfotech.com/projects/ekka/ekka-v37/ekka-admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Jun 2024 12:09:38 GMT -->
        ...
        <head>
            ...
            <link href="{{ asset('admin/assets/plugins/data-tables/datatables.bootstrap5.min.css') }}"
                rel="shortcut icon" />
            <link href="{{ asset('admin/assets/plugins/data-tables/responsive.datatables.min.css') }}"
                rel="shortcut icon" />
            <style>
                .model {
        ...
        <body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-light ec-header-light" id="body">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown user-menu">
                                        <button class="dropdown-toggle nav-link ec-drop" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <img src="{{ auth()->user()->img }}" width="30px" height="40px"
            ...
            <script src="{{ asset('admin/assets/js/delete.js') }}"></script>
