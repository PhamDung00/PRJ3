...
<head>
    ...
    <link href="{{ asset('admin/assets/plugins/data-tables/datatables.bootstrap5.min.css') }}" rel="shortcut icon" />
    <link href="{{ asset('admin/assets/plugins/data-tables/responsive.datatables.min.css') }}" rel="shortcut icon" />
    <style>
        .model {
