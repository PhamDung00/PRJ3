                            ...
                            <div class="table-responsive">
                                <table id="responsive-data-table" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><img src="{{ $iuser->img }}" width="45px" height="45px" alt="" /></td>
                                            <td>{{ $iuser->name }}</td>
                                            <td>{{ $iuser->email }}</td>
                                            <td>{{ $iuser->phone }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group mb-1">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('users.edit', $iuser->id) }}">Edit</a>
                                                        <form action="{{ route('users.destroy', $iuser->id) }}" id="form-delete{{ $iuser->id }}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <a class="dropdown-item delete-item cursor-pointer" data-id="{{ $iuser->id }}" onclick="event.preventDefault(); confirmDelete().then(() => { document.getElementById('form-delete{{ $iuser->id }}').submit(); }).catch(() => {});">
                                                                Delete
                                                            </a>
                                                        </form>   
                                                    </div>
